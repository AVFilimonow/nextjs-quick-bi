...
export const TrialForm = (props) => {
    return (
        <div className="block lg:flex lg:items-center lg:justify-center lg:fixed lg:top-[0px] lg:left-[0px] w-full lg:h-full h-screen">
            <div className="lg:relative z-20 bg-gray lg:w-[80%] lg:rounded-[20px] px-[20px] h-full lg:max-h-[80%] flex flex-col justify-start lg:px-[171px] lg:py-[81px]">
            ...
            {/* <div className="bg-gray px-[20px] h-full flex flex-col justify-start lg:px-[171px] lg:py-[81px] lg:max-h-[800px] lg:w-[80%] lg:z-50 lg:top-[35%] lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:absolute lg:rounded-[20px]">
                    <div className="hidden lg:flex items-start justify-between ">
                        <h2
                            className={
