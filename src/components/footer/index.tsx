...
import { Button, TrialForm, Section, Container } from "@/components";
...
export const Footer = (props) => {
    ...
    return (
        <div>
            ...
            {!openModal && (
                <footer className="bg-black pt-[60px] lg:py-[0px] h-screen lg:h-full lg:px-[0px] items-start flex flex-col justify-between">
                    <section className="w-full lg:relative lg:mx-auto">
                        <Container className="">
                            <Section>
                                <div
                    ...
                    <div className="lg:hidden w-full bg-white flex justify-between py-[24px] px-[16px]">
                        <button
                            onClick={() => {
                                setOpenModal(true);
                            }}
                        ...
                        <div className="flex w-[50%] md:justify-start justify-between border-l-[1px] border-l-[#292929] pl-[30px]">
                            <a href="#" className="md:mr-[32px] mr-[0px]">
                                <img
