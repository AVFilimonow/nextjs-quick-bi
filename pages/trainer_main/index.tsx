                                    ...
                                    <div className="lg:flex lg:items-start lg:justify-between mb-[184px] lg:flex-wrap">
                                        ...
                                        <div className="lg:flex lg:justify-between font-['PT-Root-UI'] w-[45%] text-[18px]">
                                            <span>
                                                ...
                                                без интенсивной аэробной
                                                нагрузки. Тренировка проходит в
                                                спокойном темпе, с преобладающим
                                                количеством статических
                                                упражнений.
                                                <br />
                                                <br />
                                                Уровень LITE - был создан
                                                специально для новичков и для
                                                тех, кто совсем без опыта, имел
                                                большой перерыв между занятиями
                                                спортом или просто любит
                        ...
                        <section className="flex flex-col items-center">
                            ...
                            <div className="text-left text-p4 text-[#292929] font-['PT-Root-UI'] flex-grow ">
                                ...
                                <p className="mb-[4px]">
                                    ...
                                    adipiscing elit. Fermentum amet, ipsum
                                    senectus felis.
                                </p>
                                <p className="mb-[4px]">
                                    Lorem ipsum dolor sit amet, consectetur
