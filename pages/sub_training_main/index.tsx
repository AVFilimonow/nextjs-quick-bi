...
import { Button, Header, Section, TrainingQuiz } from "@/components";
                                    ...
                                    <div className="max-w-[1920px] lg:block lg:flex lg:flex-col lg:px-[176px] lg:pt-[120px]">
                                        <div className="bg-gray hidden lg:block lg:flex lg:items-start lg:mb-[64px]">
                                            ...
                                            <div className="lg:w-[45%] lg:text-[18px] font-['PT-Root-UI']">
                                                <span>
                                                    Комплексная растяжка всего
                                                    тела без интенсивной
                                                    аэробной нагрузки.
                                                    Тренировка проходит в
                                                    спокойном темпе, с
                                                    преобладающим количеством
                                                    статических упражнений.{" "}
                                                    <br />
                                                    <br />
                                                    Уровень LITE - был создан
                                                    специально для новичков и
                                                    для тех, кто совсем без
                                                    опыта, имел большой перерыв
                                                    между занятиями спортом или
                                                    просто любит спокойные,
