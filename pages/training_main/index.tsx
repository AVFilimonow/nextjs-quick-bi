                        ...
                        <Section className="mr-auto max-w-[1920px] hidden lg:block lg:flex items-start">
                            ...
                            <div className="lg:w-[45%] lg:text-[18px] font-['PT-Root-UI']">
                                <span>
                                    ...
                                    тренировки, направленной на укрепление
                                    спины, похудение и проработку ягодиц, после
                                    которой идет растяжка на все тело с акцентом
                                    на все виды шпагатов - продольный и
                                    поперечный. Это наше основное направление и
                                    большинство девочек начинают именно с него.
                                    Есть также уровень лайт, без аэробной
                                    нагрузки.
                                </span>
                            </div>
                        </Section>
